...
public class GASchedulingAlgorithm {
	public static int popsize;//=20;//子代个数
	public static int gmax;//=100;//迭代次数
	public static double crossoverProb;//=0.8;//交叉概率
	public static double mutationRate;//=0.01;//变异概率
