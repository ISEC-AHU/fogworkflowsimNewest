...
public class PsoScheduling {
	public static int particleNum;//=20;//粒子数
	public static int iterateNum;//=100;//迭代次数
	public static double c1;// = 1.37;//学习因子c1
	public static double c2;// = 1.37;//学习因子c2
	public static double w;// = 0.73;//惯性权重
