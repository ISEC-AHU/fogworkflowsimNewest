...
public class Test15 extends JFrame {
	...
	private final JLabel lblCustomAlgorithmParameter = new JLabel("Custom Algorithm Parameter Setting");
...
//		FitTableColumns(table);
		...
		cloudPanel.setBounds(233, 10, 317, 95);
		...
		fogPanel.setBounds(233, 115, 317, 95);
		...
		fogPanel.add(jLabel);
		mobilePanel.setBounds(233, 220, 317, 95);
		...
		btnAddAlgorithm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JFileChooser jfc=new JFileChooser();
		        jfc.setFileSelectionMode(JFileChooser.FILES_ONLY);
		        jfc.setCurrentDirectory(new File("fogworkflowsim/Algorithms"));// 文件选择器的初始目录定为e盘
		        FileNameExtensionFilter filter = new FileNameExtensionFilter("xml文件(*.xml)", "xml");
		        jfc.setFileFilter(filter);
